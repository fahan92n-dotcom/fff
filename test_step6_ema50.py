...
class TestStep6RequiresBaseEma50(unittest.TestCase):
    def test_buy_step6_fails_when_base_stays_above_ema50(self):
    ...
    def test_sell_step6_fails_when_base_stays_below_ema50(self):
        import cascade_steps as steps
