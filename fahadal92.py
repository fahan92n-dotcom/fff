...
FAST_FETCH_CANDLES = {"1m": 12_000, "60m": 6_000}
API_FETCH_CANDLES = {"1m": 12_000, "60m": 6_000}
CACHE_MAX_CANDLES = {"1m": 14_000, "60m": 7_000, "5m": 6_000}
...
def handle_check5(chat_id, symbol="BTCUSDT"):
    ...
    try:
        ...
        fresh = get_ohlcv(symbol, "5m", target=2000)
        if not fresh.empty:
